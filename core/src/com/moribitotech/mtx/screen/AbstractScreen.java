...
public abstract class AbstractScreen implements Screen {
	...
	public AbstractScreen(AbstractGame game, String screenName) {
		...
		// i'm luyentm, fix this bug
		// stage.getCamera().position.set(AppSettings.SCREEN_W / 2,
		// AppSettings.SCREEN_H / 2, 0);\
		Viewport luyentmViewPort = new ScreenViewport();
		luyentmViewPort.setScreenSize((int) AppSettings.SCREEN_W,
				(int) AppSettings.SCREEN_H);
		stage = new Stage(luyentmViewPort);
